...
def idf(term, documents)
  ...
  # Math.log(number_of_documents.to_f / number_of_documents_with_term) # needs to make it a float or it rounds down to 0 and skews the results
...
documents = [document3]#[document1, document2, document3]
